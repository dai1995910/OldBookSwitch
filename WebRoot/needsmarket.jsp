...
<html>
  <head>
    ...
    <title>My JSP 'needsmarket.jsp' starting page</title>
                ...
                <nav id="smoothmenu1" class="ddsmoothmenu mainMenu">
                  <ul id="nav">
                     <li><a href="osi_index.action" title="Home">主页</a></li>
                  	...
                  	<li class="active"><a href="osi_reqIndex.action" title="demand">需求市场</a></li>
            	...
            	<s:actionerror/>  
                  ...
                  <s:iterator value="valueList" var="list">
                    <li>
                      ...
                      <a class="add-cart left" href="osi_qitem?sellItemId=<s:property value="#list.sellItemId"/>"title="view">查看详情</a> 
                      </div>
