...
<html>
  <head>
    ...
    <title>My JSP 'my_needs.jsp' starting page</title>
 ...
 <body>
	<div class="mainContainer sixteen container">
            ...
            <section class="content-wrapper">
            	...
            	<div>你当前所在位置：我的需求单 </div>
            	
            	<a class="colors-btn" href="need.jsp">发布需求</a>
            ...
            <s:iterator value="#request.pageBean.valueList" var="list">
				...
				<li>
					...
					<div>买家：<s:property value="#list.sellerName"/></div>
					<div>买家联系方式：<s:property value="#list.sellerContect"/></div>
				</li>
			</ul>
		  ...
		  <input class="texts" value='<s:property value="#list.btnText"/>' type="submit"/>
		  </form>
